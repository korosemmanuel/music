let musicDB = [
    ...
    },
    {
        id: 1,
        name: "Honky Tonk",
        author_name: "Randy Travis",
        img: "notAvailable.jpg",
        lang: "local",
        timesPlayed: 0,
        type:"Instrumental",
        musicName: "Honky Tonk - Randy Travis.mp3",
        attribution: {
            song: "Honky Tonk",
            musicBy: "Randy Travis",
            download: null,
            stream: null
        }
    },
    ...
    },
    {
        id: 5,
        name: "Unity",
        author_name: "Allan Walker",
        img: "avatar2.jpg",
        lang: "ENGLISH",
        timesPlayed: 0,
        type: "instrumental",
        musicName: "Alan_Walker_-_Unity_(Lyrics)_ft._Walkers(128kbps).mp3",
        attribution: {
            song: "Alan_Walker_-_Unity_(Lyrics)_ft._Walkers(128kbps)",
            musicBy: "NoCopyrightSounds",
    ...
    },
    {
      id: 1,
      name: "Never Too Late",
      author_name: "Siddy Ranking",
      img: "notAvailable.jpg",
      lang: "English",
      timesPlayed: 0,
      type:"instrumental",
      musicName: "Never Too Late.mp3",
      attribution: {
          song: "Never Too Late",
          musicBy: "Siddy",
          download: null,
  ...
  },
  {
    id: 1,
    name: "Alone",
    author_name: "Alan_Walker",
    img: "notAvailable.jpg",
    lang: "English",
    timesPlayed: 0,
    type:"instrumental",
    musicName: "Alan_Walker_-_Alone.mp3",
    attribution: {
        song: "Alone",
        musicBy: "Alan_Walker",
        download: null,
...
},
{
  ...
  timesPlayed: 0,
  type:"instrumental",
  musicName: "Alan Walker Style , Axel Johansson - Do Or Die (Albert Vishi Edit).mp3",
  attribution: {
      song: "Do Or Die",
      musicBy: "Alan_Walker",
      download: null,
...
},
{
  ...
  timesPlayed: 0,
  type:"instrumental",
  musicName: "Alan_Walker_-_Darkside__feat._Au_Ra_and_Tomine_Harket_.mp3",
  attribution: {
      song: "Darkside",
      musicBy: "Alan_Walker",
      download: null,
...
{
  id: 1,
  name: "OneDrop Reggae Mix",
  author_name: "OneDrop",
  img: "notAvailable.jpg",
  lang: "English",
  timesPlayed: 0,
  type:"reggae",
  musicName: "OneDrop Reggae Mix.mp3",
  attribution: {
      song: "Reggae mix",
      musicBy: "Grauchi",
      download: null,
